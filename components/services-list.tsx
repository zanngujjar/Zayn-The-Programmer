...
const services = [
  ...
  {
    title: "Custom Webscraper For Any Website",
    description:
      "Professional, responsive webscraper for any website. Perfect for data collection, data analysis, and more.",
    image: "/scraper2.png",
    price: "Starting at $30",
    duration: "5-10 days",
    rating: "5.0",
    orders: "5+",
    features: ["Responsive Design", "Fast Loading", "Desktop-First", "Full-Stack", "Database Management", "Automation", "Data Collection"],
    fiverr: "https://www.fiverr.com/zayn_programmer/build-a-scraper-for-any-website?context_referrer=seller_page&ref_ctx_id=a5a94e24af624fd4af9978f51eb15704&pckg_id=1&pos=2&seller_online=true&imp_id=c8957d74-d598-48a4-a55f-feaf618078ca",
    popular: false,
  },
  {
    title: "Vibe Code Audit and Optimization",
    description:
      "Professional, responsive code audit and optimization. Perfect for Production ready applications, Business applications, and more.",
    image: "/code.png",
    price: "Starting at $15",
    duration: "2-5 days",
    rating: "5.0",
    orders: "7+",
    features: ["Responsive Design", "Code Optimization", "AI", "Full-Stack", "Database Management", "Payment Intergration", "Production Ready"],
    fiverr: "https://www.fiverr.com/zayn_programmer/fix-and-optimize-your-vibe-coding?context_referrer=seller_page&ref_ctx_id=a5a94e24af624fd4af9978f51eb15704&pckg_id=1&pos=3&seller_online=true&imp_id=acc3dc87-233a-4d84-a1da-aae4dde8aee9",
    popular: true,
  },
